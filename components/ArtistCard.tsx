  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-black/30 group-hover:bg-[#ff6b9d]/20 transition-colors duration-500" />
      </div>
      ...
      <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-between pointer-events-none">
        ...
        <div>
          ...
          <motion.p 
            className="text-sm font-medium uppercase tracking-widest text-[#ff8c42] group-hover:text-[#00d9ff] mt-2 will-change-transform transition-colors duration-300"
            variants={{
              rest: { opacity: 0, y: 10 },
              hover: { opacity: 1, y: 0 }
            }}
